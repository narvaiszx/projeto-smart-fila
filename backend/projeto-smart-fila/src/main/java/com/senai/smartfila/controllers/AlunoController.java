...
public class AlunoController {
	...
	public ResponseEntity<Object> excluir(@PathVariable Long id) {
		...
		if(aluno.isPresent()) {
			...
			return ResponseEntity.status(HttpStatus.OK).body("Sucesso: O aluno foi excluído permanentemente!");
		}
		
		return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Erro: Não foi possível deletar. O aluno com ID " + id + " não foi encontrado.");
	}
}
